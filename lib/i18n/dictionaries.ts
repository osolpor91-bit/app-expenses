...
export const dictionaries = {
  es: {
    ...
    treasuryGeneral: {
      ...
      treasuryMovementExpenseClosed: "Gasto cerrado",
    ...
    treasuryBalance: {
      ...
      expenseDifference: "Gasto previsto aplicado",
      balance: "Balance",
      total: "Total general",
      totalBalance: "TOTALES",
      realBalance: "Balance real",
    ...
    workGroups: {
      ...
      reportTitle: "Informe Grupos trabajo",
      code: "Código",
      ...
      viewAssignedGroups: "Ver grupos asignados",
      viewAllGroups: "Ver todos los grupos",
      membersWithWork: "Miembros con trabajo",
      membersWithWorkReportTitle: "Miembros con trabajo",
      assignedCount: "Asignados",
      assignedGroupsCount: "Grupos",
      assignedGroupsTitle: "Grupos asignados",
      allGroupsTitle: "Todos los grupos",
      backToWorkGroups: "Volver a grupos de trabajo",
      member: "Miembro",
      selectWorkGroup: "Selecciona un grupo de trabajo.",
      searchMember: "Buscar miembro",
      searchMemberPlaceholder: "Escribe un nombre...",
      selectedMembers: "Miembros seleccionados",
      leadMember: "Encargado",
      markAsLead: "Marcar como encargado",
      noSelectedMembers: "Todavía no hay miembros seleccionados.",
      ...
      noMembersWithWork: "TodavÃ­a no hay miembros con grupos asignados.",
      noWorkGroups: "Crea al menos un grupo de trabajo para asignar miembros.",
      emptyList: "No hay grupos de trabajo creados.",
      errorReading: "Error leyendo grupos de trabajo",
      errorRefreshing: "Error actualizando grupos de trabajo",
      membersReadError: "Error leyendo miembros",
      assignmentsReadError: "Error leyendo asignaciones de grupos",
      noActiveCompanyDescription:
        "No hay una empresa activa. Selecciona una empresa para consultar grupos.",
      morning: "Mañana",
      afternoon: "Tarde",
      reportLeadHelp:
        "El encargado de cada grupo de trabajo aparecerá en rojo en dicho grupo.",
      grid: {
        deleteSelected: "Eliminar seleccionados",
        selectedSuffix: "seleccionado(s)",
        helpText: "Edita los grupos de trabajo directamente en la lista.",
        createRequiredFields: "Para crear un grupo informa el Código.",
        requiredFields: "El Código es obligatorio.",
        saveError: "Error al guardar el grupo de trabajo",
        createError: "Error al crear el grupo de trabajo",
        deleteError: "Error al eliminar grupos de trabajo",
        recordCreated: "Grupo de trabajo creado correctamente.",
        changeSaved: "Grupo de trabajo actualizado correctamente.",
        selectAtLeastOneToDelete:
          "Selecciona al menos un grupo para eliminar.",
        confirmDelete: "¿Seguro que quieres eliminar {count} grupo(s)?",
        noRowsDeleted: "No se ha eliminado ningún grupo.",
        recordsDeleted: "Grupos de trabajo eliminados correctamente.",
      },
    },
    ...
    attendance: {
      ...
      incompatibleAttendanceHelp:
        "Si un miembro tiene Todo el día, no aparecerá en Mañana/Tarde. Si tiene Mañana o Tarde, no aparecerá en Todo el día.",
      noSelectedMembers: "Todavía no hay miembros seleccionados.",
      add: "Añadir",
      remove: "Quitar",
      saved: "Asistencia guardada correctamente.",
      saveError: "Error al guardar la asistencia",
      errorReading: "Error leyendo asistencia",
      membersReadError: "Error leyendo miembros",
      noAttendance: "Todavía no hay asistencia registrada.",
      noActiveCompanyDescription:
        "No hay una empresa activa. Selecciona una empresa para registrar asistencia.",
      morningCount: "Mañanas",
      afternoonCount: "Tardes",
      fullDayCount: "Días completos",
      totalCount: "Total",
      morningShort: "Mañ.",
      afternoonShort: "Tard.",
      fullDayShort: "Días",
    ...
    items: {
      ...
      bulkInventoryAdjustmentError: "Error al ajustar inventario",
      bulkInventoryAdjustmentNoChanges: "Sin diferencias",
    ...
    itemBalanceEntries: {
      ...
      modifyTitle: "Modificar movimiento",
      modifyError: "Error al modificar movimiento",
      saving: "Guardando...",
      accept: "Aceptar",
      close: "Cerrar",
      commentPlaceholder: "Comentario libre",
  ...
  en: {
    ...
    treasuryGeneral: {
      ...
      treasuryMovementExpenseClosed: "Expense closed",
    ...
    treasuryBalance: {
      ...
      expenseDifference: "Applied expected expense",
      balance: "Balance",
      total: "Grand total",
      totalBalance: "TOTALS",
      realBalance: "Actual balance",
    ...
    workGroups: {
      ...
      membersWithWork: "Members with work",
      membersWithWorkReportTitle: "Members with work",
      assignedCount: "Assigned",
      assignedGroupsCount: "Groups",
      assignedGroupsTitle: "Assigned groups",
      allGroupsTitle: "All groups",
      backToWorkGroups: "Back to work groups",
      member: "Member",
      selectWorkGroup: "Select a work group.",
      searchMember: "Search member",
      searchMemberPlaceholder: "Type a name...",
      ...
      noMembersWithWork: "There are no members with assigned groups yet.",
      noWorkGroups: "Create at least one work group to assign members.",
      emptyList: "There are no work groups.",
      errorReading: "Error reading work groups",
      errorRefreshing: "Error refreshing work groups",
      membersReadError: "Error reading members",
      assignmentsReadError: "Error reading group assignments",
      noActiveCompanyDescription:
        "There is no active company. Select a company to view groups.",
      morning: "Morning",
      afternoon: "Afternoon",
      reportLeadHelp:
        "The lead for each work group appears in red in that group.",
      grid: {
        deleteSelected: "Delete selected",
        selectedSuffix: "selected",
        helpText: "Edit work groups directly in the list.",
        createRequiredFields: "Enter Code to create a work group.",
        requiredFields: "Code is required.",
        saveError: "Error saving work group",
        createError: "Error creating work group",
        deleteError: "Error deleting work groups",
        recordCreated: "Work group created successfully.",
        changeSaved: "Work group updated successfully.",
        selectAtLeastOneToDelete:
          "Select at least one work group to delete.",
        confirmDelete: "Are you sure you want to delete {count} group(s)?",
        noRowsDeleted: "No work group was deleted.",
        recordsDeleted: "Work groups deleted successfully.",
      },
    },
    ...
    attendance: {
      ...
      noMemberResults: "No members match that search.",
      incompatibleAttendanceHelp:
        "If a member has Full day, they will not appear for Morning/Afternoon. If they have Morning or Afternoon, they will not appear for Full day.",
      noSelectedMembers: "No members selected yet.",
      add: "Add",
      remove: "Remove",
      saved: "Attendance saved successfully.",
      saveError: "Error saving attendance",
      errorReading: "Error reading attendance",
      membersReadError: "Error reading members",
      noAttendance: "There is no attendance yet.",
      noActiveCompanyDescription:
        "There is no active company. Select a company to register attendance.",
      morningCount: "Mornings",
      afternoonCount: "Afternoons",
      fullDayCount: "Full days",
      totalCount: "Total",
      morningShort: "Mor.",
      afternoonShort: "Aft.",
      fullDayShort: "Days",
    ...
    items: {
      ...
      bulkInventoryAdjustmentError: "Error adjusting inventory",
      bulkInventoryAdjustmentNoChanges: "No differences",
      selectedItem: "Item",
    ...
    itemBalanceEntries: {
      ...
      modifyAction: "Modify",
      modifyTitle: "Modify movement",
      modifyError: "Error modifying movement",
      saving: "Saving...",
      accept: "Accept",
      close: "Close",
      commentPlaceholder: "Free comment",
