    ...
    <main className="flex min-h-screen items-center justify-center bg-app-soft px-4 text-app">
      <section className="card-app w-full max-w-md p-6">
        ...
        <form onSubmit={handleRegister} className="mt-6 space-y-4">
          ...
          {message && (
            <div className="rounded-lg border border-app bg-app-soft px-3 py-2 text-sm text-app-muted">
              {message}
            </div>
          )}
        ...
        <p className="mt-4 text-sm text-app-muted">
          ...
          <a href="/login" className="font-semibold text-primary-app underline">
            {labels.login}
          </a>
        </p>
      </section>
